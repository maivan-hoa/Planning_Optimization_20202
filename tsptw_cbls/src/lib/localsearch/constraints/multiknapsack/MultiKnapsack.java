package lib.localsearch.constraints.multiknapsack;


import lib.localsearch.model.*;
...
public class MultiKnapsack extends AbstractInvariant implements IConstraint {
	...
	public static void main(String[] args) {
		...
		mns.print();
		 ...
		 lib.localsearch.applications.Test T = new lib.localsearch.applications.Test();
		 T.test(S, 10000);
		 
		 if(true) return;
		 lib.localsearch.search.TabuSearch ts = new lib.localsearch.search.TabuSearch();
			ts.search(S, 10, 5, 100000, 100);
		 //lib.localsearch.search.SA_search ts=new lib.localsearch.search.SA_search();
